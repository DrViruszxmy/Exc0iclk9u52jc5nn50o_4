<div class="wrapper">
		...
		<div class="row">
			...
			<div class="col-md-6 padding-right-zero">
				<div class="input-group type-postion">
					...
					<select name="" id="" class="search-bar-date form-control" @change="changeType('Senior High')" v-model="senior_high_type">
	...
	<body>
		<div class="college-cpanel-wrapper">
			<div v-for="process in seniorHighProcess" v-if="seniorHighProcess.length > 0">
				<div class="row college-flow-row" @click="selectProcess(process)">
					...
					@if(accessModule($access, 'Activate'))
						<div class="col-md-3 padding-zero">
							...
							<div v-else>
								<button type="button" class="btn btn-danger form-control flow-activate-cpanel" @click="active(process)">Activate</button>
							</div>
						</div>
					@endif
				</div>
