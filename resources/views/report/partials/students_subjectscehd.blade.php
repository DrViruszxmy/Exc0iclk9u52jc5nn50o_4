...
<body>
    <div class="sh-dashboard-prev">
        <div v-show="isTable == false">
            <br>
            <line-chart :schools="subSchedSubjects" :male="subSchedMaleChartCount" :female="subSchedFemaleChartCount" :ischangelog="ischangelog"></line-chart>
            <br>
            <div class="row">
                <div class="col-md-4">
        ...
        <template v-if="isTable == true">
            <div class="r-table-w">
                <template v-if="student_subjects_sched.length > 0">
                    <div class="row">
                        <div class="col-md-12">
    ...
    <!--             <template v-else>
                ...
                <br>
                <div class="row">
                    <div class="col-md-12" v-if="student_subjects_sched.length > 0">
                        <div id="print-subsched">
                            ...
                            <table class="table" width="100%" id="students-subject-table">
                                <thead class="">
                                    <tr>
                                        <th>Section</th>
                                        <th class="sub-w25">Subject</th>
                                        <th>Day</th>
                                        <th class="sub-w40">Time</th>
                                        <th class="sub-w15">Room</th>
                                        <th class="sub-w15">Instructor</th>
                                        <th class="text-center sub10">Male</th>
                                        <th class="text-center sub10">Female</th>
                                        <th class="text-center sub10">No. of Students</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr v-for="subject in student_subjects_sched" v-cloak>
                                        <td>@{{ subject.section.sec_code }}</td>
                                        <td>@{{ subject.subject_list.subj_name }}</td>
                                        <td>
                                            <div v-for="schedule in subject.schedule_days">
                                                @{{ schedule.sched_day.abbreviation }}
                                            </div>
                                        </td>
                                        <td>
                                            <div v-for="schedule in subject.schedule_days">
                                        ...
                                        <td>
                                            <div v-for="schedule in subject.schedule_days">
                                                <small>@{{ schedule.room_list.room_code }} (@{{ schedule.type }})</small>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-center">@{{ subject['male'] }}</td>
                                        <td class="text-center">@{{ subject['female'] }}</td>
                                        <td class="text-center">@{{ subject['total'] }}</td>
                                    </tr>
                                </tbody>
                                <tfoot>
                                    <tr v-cloak>
                                        <td colspan="6"><h3 class="margin-zero">Total:</h3></td>
