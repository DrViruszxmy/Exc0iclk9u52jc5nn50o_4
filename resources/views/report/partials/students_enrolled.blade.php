            ...
            <div class="row">
                <div class="col-md-4 col-sm-4 padding-zero">
                    <div class="row">
                        ...
                        <div class="col-md-4 padding-zero">
                            <select name="" class="studinfo-select" v-model="school_lvl" @change="studentsEnrolled">
                ...
                <div class="col-md-4 col-sm-5 padding-zero">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <select name="" class="studinfo-select" v-model="academic_year" @change="studentsEnrolled">
                                <option value="" selected disabled>Select</option>
                ...
                <div class="col-md-4 col-sm-6 padding-zero">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <select name="semester" class="studinfo-select" v-model="semester" @change="studentsEnrolled">
                                <option value="" selected disabled>Select</option>
...
<body>
    <div class="sh-dashboard-prev">
        <div v-show="isTable == false">
            <div id="">
                <br>
                <line-chart id="printchart-suben" :schools="schools" :male="maleChartCount" :female="femaleChartCount" :ischangelog="ischangelog"></line-chart>
                <br>
                <div class="row">
                    <div class="col-md-4">
        ...
        <template v-if="isTable == true">
            <div class="r-table-w">
                <div class="row" v-if="total_enrolled_students.length > 0">
                    <div class="col-md-12">
                ...
                <br>
                <div class="row">
                    <div class="col-md-12" v-if="total_enrolled_students.length > 0">
                        <div id="print-suben">
                            ...
                            <table class="table" width="100%" id="students-enrolled-table">
                                <thead class="">
                                    <tr>
                                ...
                                <tbody>
                                    <tr v-for="total_enrolled_student in total_enrolled_students" v-cloak>
                                        <td>@{{ total_enrolled_student['school_name'] }}</td>
                                        <td class="text-center">@{{ total_enrolled_student['total'] }}</td>
                                        <td class="text-center">@{{ total_enrolled_student['male'] }}</td>
                                        <td class="text-center">@{{ total_enrolled_student['female'] }}</td>
                                    </tr>
                                </tbody>
                                <tfoot>
                                    <tr v-cloak>
