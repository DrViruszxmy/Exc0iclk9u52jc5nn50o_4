            ...
            <div class="row">
                <div class="col-md-4 col-sm-4 padding-zero">
                    <div class="row">
                        ...
                        <div class="col-md-4 padding-zero">
                            <select name="" class="studinfo-select" v-model="school_lvl" @change="studentsTransferee">
                ...
                <div class="col-md-4 col-sm-5 padding-zero">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <select name="" class="studinfo-select" v-model="academic_year" @change="studentsTransferee">
                                <option value="" selected disabled>Select</option>
                ...
                <div class="col-md-4 col-sm-6 padding-zero">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <select name="semester" class="studinfo-select" v-model="semester" @change="studentsTransferee">
                                <option value="" selected disabled>Select</option>
...
<body>
    <div class="sh-dashboard-prev">
        <div v-show="isTable == false">
            <br>
            <line-chart :schools="transSchools" :male="transMaleChartCount" :female="transFemaleChartCount" :ischangelog="ischangelog"></line-chart>
            <br>
            <div class="row">
                <div class="col-md-4">
        ...
        <template v-if="isTable == true">
            <div class="r-table-w">
                <template v-if="total_transferee_students.length > 0">
                    <div class="row">
                        <div class="col-md-12">
    ...
    <!--             <template v-else>
                ...
                <br>
                <div class="row">
                    <div class="col-md-12" v-if="total_transferee_students.length > 0">
                        <div id="print-suben">
                            ...
                            <table class="table" width="100%" id="students-transferee-table">
                                <thead class="">
                                    <tr>
                                ...
                                <tbody>
                                    <tr v-for="total_transferee_student in total_transferee_students" v-cloak>
                                        <td>@{{ total_transferee_student['school_name'] }}</td>
                                        <td class="text-center">@{{ total_transferee_student['total'] }}</td>
                                        <td class="text-center">@{{ total_transferee_student['male'] }}</td>
                                        <td class="text-center">@{{ total_transferee_student['female'] }}</td>
                                    </tr>
                                </tbody>
                                <tfoot>
                                    <tr v-cloak>
